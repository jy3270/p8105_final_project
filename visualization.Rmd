...
fig <- plot_ly(happy, type = 'choropleth', locations = happy$code, z = happy$mean_ladder_score, text = happy$country_name, colors = 'Blues')

fig %>% 
  layout(
    title = "Global Mean Life Ladder Score Across Years",
    geo = g
  )
```
